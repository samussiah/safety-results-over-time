(function (global, factory) {
    ...
    function syncSettings(settings) {
        ...
        settings.marks[1].per = [settings.id_col, settings.measure_col, settings.time_settings.value_col, settings.value_col];
    ...
    function flagOutliers() {
        ...
        this.filtered_measure_data.forEach(function (d) {
            ...
            d.outlier = _this.config.outliers ? d[_this.config.y.column] < quantiles[0] || quantiles[1] < d[_this.config.y.column] : false;
        });
    }
    ...
    function drawPlots() {
        ...
        this.nested_measure_data.filter(function (visit) {
            ...
            visit.values.forEach(function (group, i) {
                ...
                _this.circles.groups.filter(function (d) {
